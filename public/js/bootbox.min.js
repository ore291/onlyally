(function (a, b) {
  ...
  var m = {
    dialog:
      "<div className='bootbox modal' tabindex='-1' role='dialog'><div className='modal-dialog'><div className='modal-content'><div className='modal-body'><div className='bootbox-body'></div></div></div></div></div>",
    header:
      "<div className='modal-header'><h4 className='modal-title'></h4></div>",
    footer: "<div className='modal-footer'></div>",
    closeButton:
      "<button type='button' className='bootbox-close-button close' data-dismiss='modal' aria-hidden='true'>&times;</button>",
    ...
    inputs: {
      ...
      textarea:
        "<textarea className='bootbox-input bootbox-input-textarea form-control'></textarea>",
      email:
        "<input className='bootbox-input bootbox-input-email form-control' autocomplete='off' type='email' />",
      select:
        "<select className='bootbox-input bootbox-input-select form-control'></select>",
      checkbox:
        "<div className='checkbox'><label><input className='bootbox-input bootbox-input-checkbox' type='checkbox' /></label></div>",
      ...
      number:
        "<input className='bootbox-input bootbox-input-number form-control' autocomplete=off type='number' />",
      password:
        "<input className='bootbox-input bootbox-input-password form-control' autocomplete='off' type='password' />",
    },
  };
  var f = {
    locale: "en",
  ...
  h.dialog = function (t) {
    ...
    k(x, function (z, y) {
      v +=
        ...
        z +
        "' type='button' className='custom-btn-authentication btn " +
        y.className +
        "'>" +
        y.label +
        "</button>";
    ...
    if (t.className) {
      u.addclassName(t.className);
    }
    if (t.size === "large") {
      r.addclassName("modal-lg");
    } else {
      if (t.size === "small") {
        r.addclassName("modal-sm");
      }
    }
    if (t.title) {
      q.before(m.header);
