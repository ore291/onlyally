$(document).ready(function () {
  ...
  function changePage() {
    ...
    if (page.classNameList.contains("active")) {
      return;
    }

    currentSelector.classNameList.remove("button-active");
    currentSelector.classNameList.add("button-inactive");
    currentPage.classNameList.remove("active");
    currentPage.classNameList.add("inactive");

    pageSelector.classNameList.remove("button-inactive");
    pageSelector.classNameList.add("button-active");

    page.classNameList.remove("inactive");
    page.classNameList.add("active");
...
$(document).ready(function () {
  $(document).ready(function () {
    $(".js-gallery").slick({
      ...
      slidesToScroll: 1,
      prevArrow:
        '<span className="gallery-arrow mod-prev glyphicon glyphicon-chevron-left"></span>',
      nextArrow:
        '<span className="gallery-arrow mod-next glyphicon glyphicon-chevron-right"></span>',
    });
...
$(document).ready(function () {
  ...
  submitIcon.click(function () {
    if (isOpen == false) {
      searchBox.addclassName("searchbox-open");
      inputBox.focus();
      isOpen = true;
    } else {
      searchBox.removeclassName("searchbox-open");
      inputBox.focusout();
      isOpen = false;
    }
  });
