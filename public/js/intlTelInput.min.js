          ...
          d(c, [
            {
              ...
              value: function () {
                ...
                if (
                  ...
                  this.g &&
                    (document.body.classNameList.add("iti-mobile"),
            ...
            },
            {
              ...
              value: function () {
                ...
                var b = this._e2("div", { className: a });
                if (
              ...
              value: function (a, b, c) {
                for (var d = "", e = 0; e < a.length; e++) {
                  ...
                  (d += "<li className='iti__country "
                    ...
                    (d +=
                      "<div className='iti__flag-box'><div className='iti__flag iti__".concat(
                        f.iso2,
                        "'></div></div>"
                      )),
                    (d += "<span className='iti__country-name'>".concat(
                      f.name,
                      "</span>"
                    )),
                    (d += "<span className='iti__dial-code'>+".concat(
                      f.dialCode,
                      "</span>"
                    )),
                    (d += "</li>");
            ...
            },
            {
              ...
              value: function () {
                var a = this;
                this._a9 = function (b) {
                  a.m.classNameList.contains("iti__hide")
                    ? a.a.focus()
                    : b.preventDefault();
                };
                var b = this._i1();
            ...
            },
            {
              key: "_n",
              value: function () {
                this.m.classNameList.remove("iti__hide"),
                  this.selectedFlag.setAttribute("aria-expanded", "true"),
                  this._o(),
                  this.b && (this._x(this.b, !1), this._3(this.b, !0)),
                  this._p(),
                  this.u.classNameList.add("iti__arrow--up"),
            ...
            },
            {
              key: "_n2",
              value: function (a, b, c) {
                c && !a.classNameList.contains(b)
                  ? a.classNameList.add(b)
                  : !c &&
                    a.classNameList.contains(b) &&
                    a.classNameList.remove(b);
              },
            },
            {
              key: "_o",
            ...
            },
            {
              ...
              value: function (a) {
                for (
                  ...
                  b &&
                  b !== this.m &&
                  !b.classNameList.contains("iti__country");
            ...
            },
            {
              ...
              value: function (a) {
                ...
                b &&
                  (b.classNameList.contains("iti__divider") &&
                    (b =
                      "ArrowUp" === a || "Up" === a
            ...
            },
            {
              ...
              value: function (a, b) {
                var c = this.c;
                c && c.classNameList.remove("iti__highlight"),
                  (this.c = a),
                  this.c.classNameList.add("iti__highlight"),
                  b && this.c.focus();
              },
            },
            {
            ...
            },
            {
              ...
              value: function (a) {
                ...
                (this.s = a ? this._y(a, !1, !1) : {}),
                  ...
                  this.l.setAttribute("className", "iti__flag iti__".concat(a));
                var c = a
                ...
                if ((this._0(), this.d.allowDropdown)) {
                  ...
                  if (
                    (f &&
                      (f.classNameList.remove("iti__active"),
                    ...
                    g.setAttribute("aria-selected", "true"),
                      g.classNameList.add("iti__active"),
                      (this.b = g),
            ...
            },
            {
              key: "_2",
              value: function () {
                this.m.classNameList.add("iti__hide"),
                  this.selectedFlag.setAttribute("aria-expanded", "false"),
                  this.u.classNameList.remove("iti__arrow--up"),
            ...
            },
            {
              ...
              value: function (a) {
                var b = a.toLowerCase();
                this.l.classNameList.contains("iti__".concat(b)) ||
                  (this._z(b),
