!(function (e, t) {
  ...
  function d(e, t) {
    a(t.split(" "), function (t) {
      return e.classNameList.add(t);
    });
  }
  function u(e, t) {
    a(t.split(" "), function (t) {
      return e.classNameList.remove(t);
    });
  }
  function g(e, t) {
    return e.classNameList.contains(t);
  }
  function v(e, t) {
    for (; e !== document.body; ) {
      ...
      function e(i, n) {
        ...
        (this.active = !1),
          ...
          this.img.addEventListener(
            "click",
            function (e) {
              return s.slide.classNameList.contains("dragging-nav")
                ? (s.zoomOut(), !1)
                : s.zoomedIn
        ...
        n(e, [
          {
            ...
            value: function () {
              ...
              if (!(this.zoomedIn || e <= 768)) {
                ...
                this.slide.classNameList.add("zoomed"), (this.zoomedIn = !0);
              }
            },
          },
          {
            ...
            value: function (e) {
              ...
              e.preventDefault(),
                ...
                setTimeout(function () {
                  (t.dragging = !1),
                    (t.img.isDragging = !1),
                    t.img.classNameList.remove("dragging");
                }, 100);
            },
          },
          {
        ...
        n(e, [
          {
            key: "dragStart",
            value: function (e) {
              if (this.slide.classNameList.contains("zoomed")) this.active = !1;
              else {
                "touchstart" === e.type
                  ? ((this.initialX = e.touches[0].clientX - this.xOffset),
                    (this.initialY = e.touches[0].clientY - this.yOffset))
                ...
                e.target.classNameList.contains("nodrag") ||
                v(e.target, ".nodrag") ||
              ...
              e && e.preventDefault(),
                ...
                setTimeout(function () {
                  (t.instance.preventOutsideClick = !1),
                    ...
                    (t.dragging = !1),
                    (t.el.isDragging = !1),
                    t.el.classNameList.remove("dragging"),
                    t.slide.classNameList.remove("dragging-nav"),
      ...
      n(e, [
        ...
        },
        {
          ...
          value: function () {
            ...
            u(e, this.effectsclassNamees), d(e, "prev");
