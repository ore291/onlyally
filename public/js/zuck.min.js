          ...
          var p = function (t) {
              ...
              template: {
                ...
                viewerItem: function (t, e) {
                  return '<div className="story-viewer">\n                    <div className="head">\n                      <div className="left">\n                        '
                    .concat(
                      u("backButton") ? '<a className="back">&lsaquo;</a>' : "",
                      '\n\n                        <span className="item-preview">\n                          <img lazy="eager" className="profilePhoto" src="'
                    )
                    .concat(
                      i(t, "photo"),
                ...
                viewerItemBody: function (t, e, n) {
                  return '<div \n                    className="item '
                    ...
                    .concat(
                      "video" === i(n, "type")
                        ? '<video className="media" muted webkit-playsinline playsinline preload="auto" src="'
                            .concat(i(n, "src"), '" ')
                            .concat(
                              i(n, "type"),
                              '></video>\n                        <b className="tip muted">'
                            )
                            .concat(u("language", "unmute"), "</b>")
                        : '<img loading="auto" className="media" src="'
                            .concat(i(n, "src"), '" ')
                            .concat(i(n, "type"), " />\n                    "),
                      "\n\n                    "
                    )
            ...
            h = (function () {
              ...
              c ||
                ...
                u("openEffect") && c.classNameList.add("with-effects"),
                u("rtl") && c.classNameList.add("rtl"),
                (e = function () {
                  c.classNameList.contains("closed") &&
                    ((g.innerHTML = ""),
                    (c.style.display = "none"),
                    c.classNameList.remove("closed"),
                    c.classNameList.remove("animated"));
                }),
              ...
              var g = a("#zuck-modal-content"),
                    ...
                    setTimeout(function () {
                      ...
                      if ("" !== n && r[n] && "" !== i) {
                        ...
                        o && o.parentNode.removeChild(o),
                          r.viewing &&
                            (r.viewing.classNameList.add("stopped"),
                            r.viewing.classNameList.add(i),
                            r.viewing.classNameList.remove("viewing")),
                          r[n] &&
                            (r[n].classNameList.remove("stopped"),
                            r[n].classNameList.remove(n),
                            r[n].classNameList.add("viewing"));
                        var l = k(n);
                        l && I(l, n);
                ...
                I = function (t, e, n) {
                  ...
                  var k = g.querySelector("video"),
                    w = function (t) {
                      t.muted
                        ? S.classNameList.add("muted")
                        : S.classNameList.remove("muted");
                    };
                  k &&
                    ((k.onwaiting = function (t) {
                      k.paused &&
                        (S.classNameList.add("paused"),
                        S.classNameList.add("loading"));
                    }),
                    (k.onplay = function () {
                      w(k),
                        S.classNameList.remove("stopped"),
                        S.classNameList.remove("paused"),
                        S.classNameList.remove("loading");
                    }),
                    (k.onload =
                      k.onplaying =
                      k.oncanplay =
                        function () {
                          w(k), S.classNameList.remove("loading");
                        }),
              ...
              return {
                show: function (t, e) {
                  ...
                  u("callbacks", "onOpen")(t, function () {
                            ...
                            (c = { x: v, y: p, time: Date.now(), valid: !0 }),
                              p < 80 || p > e.slideHeight - 80
                                ...
                                : (t.preventDefault(),
                                  ...
                                  n && n.classNameList.add("paused"),
                                  L(),
                                  (l = setTimeout(function () {
                                    n.classNameList.add("longPress");
                                  }, 600)),
                          ...
                          if (c && !c.valid);
                            ...
                            if (
                              ...
                              p &&
                                ...
                                p.classNameList.remove("longPress"),
                                p.classNameList.remove("paused")),
                              m)
                            ) {
                              clearInterval(m), (m = !1);
                              var A = function () {
                              ...
                              if (!T || !I) return A(), !1;
                              T.classNameList.contains("muted") ? S(I, T) : A();
                            }
                          }
                        };
                    ...
                    var r = k("next");
                    r && I(r, "next"),
                      u("autoFullScreen") && i.classNameList.add("fullscreen");
                    var s = function () {
                      i.classNameList.contains("fullscreen") &&
                        u("autoFullScreen") &&
            ...
            S = function (t, e) {
              (t.muted = !1),
                ...
                e && e.classNameList.remove("paused");
            },
            E = function (t, e) {
              try {
                if (u("localStorage")) {
              ...
              function (t, e) {
                ...
                if (c && y && g) {
                  ...
                  (b = u("callbacks", b ? "onNavigateItem" : "onNextItem"))(
                    ...
                    function () {
                      "previous" === t
                        ? (l.classNameList.remove("seen"),
                          m.classNameList.remove("seen"))
                        : (l.classNameList.add("seen"),
                          m.classNameList.add("seen")),
                        l.classNameList.remove("active"),
                        m.classNameList.remove("active"),
                        y.classNameList.remove("seen"),
                        y.classNameList.add("active"),
                        g.classNameList.remove("seen"),
                        g.classNameList.add("active"),
