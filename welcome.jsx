...
const welcome = () => {
  return (
    <>
      {/* first container */}
      <div className="w-11/12 ml-auto  mr-auto p-[5vh]  h-[80vh] flex bg-white mt-10 rounded-xl drop-shadow-[10px_10px_10px_rgba(0,0,0,0.08)] mb-10">
        <div className="w-4/12 bg-gray-200 rounded-lg h-[70vh] relative">
          <p className="text-black font-bold text-[25px] text-center mt-10">
            Looks good
          </p>
          <img
            className="w-10/12 absolute bottom-10 left-[8.85%] rounded-md"
            alt="intro"
            src="/images/body images/car.webp"
          />
        </div>
        <div className="w-[60%] bg-white rounded-xl h-[70vh] ml-10 ">
          <div className="md:flex mt-[2px]  ">
            <div className=" text-white w-fit h-[30px]  flex z-30 mb-2">
              <div className="bg-gray-500 rounded-tl-lg rounded-bl-lg w-[100px] text-center mr-[1px] font-bold">
                <p>Media</p>
              </div>
              <p className="trangle"></p>
            </div>
            <div className=" text-white w-fit h-[30px] flex relative mb-2">
              <p className="trangle-white z-20"></p>
              <div className="bg-gray-200 text-black z-10 w-[100px] h-[30px] text-center  font-bold absolute ">
                <p>Info</p>
              </div>
              <p className="trangle-grey absolute left-[100px]"></p>
            </div>
            <div className=" text-white w-fit h-[30px] flex relative md:left-[100px] ">
              <p className="trangle-white z-20"></p>
              <div className="bg-gray-200 rounded-tr-lg rounded-br-lg text-black z-10 w-[100px] h-[30px] text-center  font-bold absolute ">
                <p>Follow</p>
              </div>
            </div>
          </div>
          <div className="mt-[10%] text-center font-bold text-black">
            <p>You'll be able to add more to your profile later</p>
            <div className="relative">
              <img
                className="rounded-full w-[150px] h-[150px] ml-auto mr-auto mt-10"
                alt="profile"
                src="/images/body images/car.webp"
              />
              <AiOutlineCamera className="absolute text-white left-[55%] top-[70%] bg-gray-500 p-1 rounded-full w-[30px] h-[30px]" />
            </div>
          </div>

          <button className="bg-red-600 font-medium  text-white rounded-lg absolute bottom-10 right-10 w-[150px] h-[30px] ">
            Save & Continue
          </button>
        </div>
      </div>
      ...
      <div className="w-11/12 ml-auto  mr-auto p-[5vh]  h-[80vh] flex bg-white mt-10 rounded-xl drop-shadow-[10px_10px_10px_rgba(0,0,0,0.08)] mb-10">
        ...
        <div className="w-[60%] bg-white rounded-xl h-[70vh] ml-10 ">
          ...
          <p className="absolute bottom-20 md:bottom-10 mb-4 font-medium text-black text-[12px] md:text-[18px] ">
      ...
      <div className="w-11/12 ml-auto  mr-auto p-[5vh]  h-[80vh] flex bg-white mt-10 rounded-xl drop-shadow-[10px_10px_10px_rgba(0,0,0,0.08)] mb-10">
        ...
        <div className="w-[60%] bg-white rounded-xl h-[70vh] ml-10 ">
          <div className="md:flex mt-[2px]  ">
            ...
            <div className=" text-white w-fit h-[30px] flex relative mb-2">
              <p className="trangle-white z-20"></p>
              <div className="bg-gray-500  z-10 w-[100px] h-[30px] text-center  font-bold absolute ">
                <p>Info</p>
              </div>
              <p className="trangle absolute left-[100px]"></p>
            </div>
            <div className=" text-white w-fit h-[30px] flex relative md:left-[100px]">
              <p className="trangle-white z-20"></p>
              <div className="bg-gray-500 rounded-tr-lg rounded-br-lg  z-10 w-[100px] h-[30px] text-center  font-bold absolute ">
                <p>Follow</p>
              </div>
            </div>
          </div>
          <div className="mt-[10%] text-center font-bold text-black">
            <p>Get latest activities from our popular users</p>
            <div className="relative">
              <img
                className="rounded-xl w-[150px] h-[150px]  mt-10"
                alt="profile"
                src="/images/body images/car.webp"
              />
            </div>
          </div>
          <p className="absolute bottom-20 md:bottom-10  font-medium text-black text-[12px] md:text-[18px] ">
            Or Skip this step for now
          </p>
          <button className="bg-red-600 font-medium  text-white rounded-lg absolute bottom-10 right-10 w-[150px] h-[30px] ">
            Follow & Finish
      ...
      {/* fourth container */}
      <div className="w-11/12 ml-auto  mr-auto p-[5vh] h-[90vh]  md:h-[110vh] flex bg-white mt-10 rounded-xl drop-shadow-[10px_10px_10px_rgba(0,0,0,0.08)] mb-10">
        <div className="w-4/12 bg-gray-200 rounded-lg h-[70vh] relative">
          <p className="text-black font-bold text-[25px] text-center mt-10">
            Tell us about you
          </p>
        ...
        <div className="w-[60%] bg-white rounded-xl h-[70vh] ml-10 ">
          ...
          <div className="mt-[10%] text-center font-bold text-black">
            <p>Share your information with our community</p>
            <div className="relative">
              <div className="relative h-[45px]">
                <input
                  className="w-10/12 !border-none !outline-0 mb-10 bg-gray-200 rounded-sm "
                  type="text"
                  placeholder="first name"
                />
                <hr className="absolute text-orange-900 bg-gray-500 bottom-0 z-50 w-10/12 h-[5px] left-[8.5%]" />
              </div>
              <br />
              <div className="relative h-[45px]">
                <input
      ...
      {/* fifth container */}
      <div className="h-[90vh] w-10/12 rounded-xl flex flex-col justify-center items-center  ml-auto mr-auto  bg-white drop-shadow-[10px_10px_10px_rgba(0,0,0,0.08)] mb-10">
        <div className="w-4/12 h-2/5 bg-white flex flex-col justify-center items-center ">
          <FcCheckmark className=" bg-white rounded-full font-bold text-lg w-[25px] h-[25px]" />
