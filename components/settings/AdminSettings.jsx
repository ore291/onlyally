...
const AdminSettings = ({ data }) => {
  ...
  return (
    <div className="mt-14 bg-white shadow-sm rounded-lg">
      ...
      <div>
        <Tab.Group>
          <div className="bg-white rounded-xl p-1 mb-10 md:mb-60">
            <Tab.List className="row-container flex-wrap md:flex-nowrap p-1 space-x-5 bg-[#ecf0f5]  rounded-full px-2 md:w-2/3 mx-auto">
