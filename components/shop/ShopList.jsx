...
const ShopList = ({ otherUser }) => {
  ...
  const otherModelProducts = useSelector(
    (state) => state.products.otherModelProducts
  );
  ...
  if (otherUser) {
    return (
      <>
        <div className="bg-white dark:!bg-gray-900 dark:!text-gray-400 w-full">
          <div className="max-w-2xl mx-auto py-4 px-0 sm:px-2 lg:max-w-7xl ">
            <h2 className="text-2xl font-extrabold tracking-tight  dark:!text-gray-300">
              Featured Products
            </h2>
            {otherModelProducts.loading ? (
              "Loading..."
            ) : (
              <div className="mt-2 grid grid-cols-1 gap-y-10 gap-x-1 sm:grid-cols-2 lg:grid-cols-3 xl:gap-x-2">
  ...
  return (
    <>
      <div className="dark:bg-gray-900 dark:text-gray-400 bg-white w-full">
        <div className="max-w-2xl mx-auto py-4 px-0 sm:px-2 lg:max-w-7xl ">
