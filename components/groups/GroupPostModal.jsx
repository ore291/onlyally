...
const GroupPostModal = (props) => {
  ...
  const saveGroupPost = useSelector((state) => state.groups.saveGroupPost);
  ...
  return (
    <Transition appear show={props.categoryPost} as={Fragment}>
      <Dialog
        as="div"
              ...
              >
                ...
                >
                  {fileUpload.loadingButtonContent !== null
                    ...
                    : saveGroupPost.loadingButtonContent !== null
