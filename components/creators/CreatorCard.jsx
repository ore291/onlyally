...
const CreatorCard = ({ username, image, main, verified, creator }) => {
      ...
      <Link href={`/${creator.unique_id}`}>
        <div className="col-container my-3 cursor-pointer">
          <div className="bg-gradient-to-tr from-yellow-400 to-playRed p-0.5 rounded-2xl">
            <div className="bg-white dark:!bg-gray-900 dark:!text-gray-400 p-0.5 rounded-2xl">
          ...
          <p className="text-xs font-semibold dark:!text-gray-400 text-center whitespace-nowrap">
            {username}
          </p>
        </div>
      </Link>
  ...
  return (
    <Link href={`/${username}`} passHref>
      <div className="bg-white dark:!bg-gray-900 dark:!text-gray-400 rounded-lg shadow-sm border dark:border-gray-800  flex flex-col items-center justify-center cursor-pointer p-0.5">
