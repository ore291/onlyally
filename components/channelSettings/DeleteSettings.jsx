...
import { deleteChannelStart } from "../../store/slices/channelsSlice";
import { useDispatch, useSelector } from "react-redux";

const DeleteSettings = ({ channel }) => {
  const dispatch = useDispatch();
  const deletedChannel = useSelector((state) => state.channels.deleteChannel);
  const deleteChannel = () => {
    dispatch(deleteChannelStart(channel.slug));
  };
  return (
