...
import BookmarkEmbla from "./bookmarkEmbla.jsx";
...
import Comment from "../feeds/Comment.jsx";
import Comments from "../feeds/Comments.jsx";
import ReadMoreMaster from "../helpers/ReadMoreMaster";
import { getCookies, getCookie, setCookies, removeCookies } from "cookies-next";

const BookmarkComponent = ({ post, index }) => {
  ...
  return (
    <>
      {postDisplayStatus == true ? (
        <div className="sm:rounded-2xl bg-white sm:border shadow-md w-full md:w-[45%] lg:w-[31%] cursor-pointer mx-1 mb-16 lg:mb-10">
