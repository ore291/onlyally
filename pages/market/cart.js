        ...
        <div className="flex lg:flex-row flex-col">
            ...
            <div className="w-full overflow-x-auto">
              ...
              <table className="w-full shadow-inner">
                <thead>
                  <tr className="bg-gray-100">
                    <th className="md:px-6 py-3 font-bold whitespace-nowrap">
                      Image
                    </th>
                    <th className="md:px-6 py-3 font-bold whitespace-nowrap">
                      Product
                ...
                {cartList.loading == false &&
                  ...
                  cartList.data.carts.map((cart, i) => {
                    return <CartList cart={cart} key={i} />;
                  })}
              </table>
              <div className="flex w-full justify-between  my-6 mt-8">
                ...
                {cartList.loading == false && cartList.data.carts.length > 0 ? (
                  <button onClick={deleteAllCart} className="btn py-4">
                    REMOVE ALL CART
                  </button>
                ) : (
                  ""
          ...
          <div className="md:w-1/3 w-3/4 md:mt-32">
            <div className="border-2 h-[15rem] p-4">
              <h1 className="text-xl font-semibold mb-4 text-stone-600">
                PRICE DETAILS
              </h1>
