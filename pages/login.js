        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-2 xs:gap-y-3  ss:gap-y-[55px] text-white text-center pt-5 lg:pt-16 px-3 ">
          ...
          <div className="flex mt-6 sm:mt-20 md:mt-0 flex-col space-y-2 items items-center justify-center">
            ...
            <div className="inputBox text-gray-900 relative">
              ...
              <span className="appearance-none peer absolute right-3">
                <Link passHref href="/forgot-password" className="">
                  <FaQuestionCircle className="w-5 h-5  text-lightPlayRed cursor-pointer" />
                </Link>
              </span>

              <div className="!hidden peer-hover:!flex  absolute -right-7 rounded-md text-xs p-1 -top-4 bg-black text-white row-container font-medium">
                Forgot Password?
              </div>
            </div>
            <button
