          ...
          <div className="w-full lg:w-4/5 bg-white px-4 mx-auto mt-5 lg:mr-16 lg:ml-6 border-2 border-gray-500 rounded-md shadow py-4 space-y-6">
            <section className="space-y-2 ">
              ...
              <div className="shadow-md">
                <section className="relative w-full  h-64 rounded-md pb-8 bg-cover bg-center px-1 md:px-4 ">
                  <img
                  ...
                  <form id="coverForm" action="#">
                    ...
                    />
                    <label
                      className="absolute  right-2 md:right-5 bottom-2 btn p-4 text-sm font-medium bg-red-600 rounded-md mb-0 w-[200px] h-10 row-container cursor-pointer"
                      htmlFor="changeCover"
                      title="Change cover"
                    >
                      Upload Cover
                ...
                <section className="w-full px-1 md:pl-8 md:pr-2 pb-4 flex mt-6 md:mt-0 justify-between md:justify-end ">
                  {" "}
                  <form
                    id="pictureForm"
              ...
              <p className="font-semibold text-gray-400 text-sm ">
                Use 144px * 144px for profile and 1960 * 960px for cover
                picture. Accept .jpg .jpeg .png and .svg format images.
              </p>
            </section>
            ...
            <section className="my-3">
              <div>
                ...
                <p className="text-sm font-medium text-gray-300">
                  Write a short and interesting bio that describes you the best
                </p>
              </div>
              ...
              <div>
                ...
                >
                  ...
                  <option
                    value="CARD"
                    selected={
                      profile.data.default_payment_method == "CARD"
                        ? true
                        : false
                    }
                  >
