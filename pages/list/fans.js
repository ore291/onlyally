        ...
        <div className="w-full lg:w-4/5 lg:mr-16 lg:ml-6 bg-white px-4 mx-auto mt-20 shadow py-4">
            ...
            <section className="my-4">
              ...
              <div className="block lg:flex justify-between flex-wrap">
                {!activeFollowers.loading ? (
                  activeFollowers.data.followers.map((EachUser, i) => (
                    <article
                    ...
                    >
                      <div className="bg-[url('/images/settings/grey.jpg')] h-32 flex justify-end items-end">
                        ...
                        <BsThreeDots
                          onClick={() =>
                            setOpenFansCardOption(!openFansCardOption)
                          }
                          size="23"
            ...
            <section className="my-4">
              ...
              <div className="block lg:flex justify-between flex-wrap">
                {!expiredFollowers.loading ? (
                  expiredFollowers.data.followers.map((EachUser, i) => (
                    <article
                      className="w-full  lg:w-1/3 border-2 border-grey-500 "
                      key={i}
                    >
          ...
          {fansTab === "all" && (
            <section className="my-4">
              ...
              <div className="block lg:flex justify-between flex-wrap">
                {!followers.loading ? (
                  followers.data.followers.map((EachUser, i) => (
                    <article
                      className="w-full  lg:w-1/3 border-2 border-grey-500 "
                      key={i}
                    >
